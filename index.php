...
<div class="cr-checkbox__wrapper signin-form__field signin__remember-me">
  <div class="cr-checkbox__widget-wrapper">
    <input type="checkbox" id="checkbox_remember" name="remember_me" class="cr-invisible-input cr-checkbox__input">

    <div class="c-checkbox-widget cr-checkbox__checkbox-widget">
      <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="check"
           class="svg-inline--fa fa-check fa-w-14 c-checkbox-widget__checkmark"
           role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
        <path fill="currentColor" d="M438.6 105.4c12.5 12.5 12.5 32.8 0 45.3l-256
        256c-12.5 12.5-32.8 12.5-45.3 0l-128-128c-12.5-12.5-12.5-32.8
        0-45.3s32.8-12.5 45.3 0L160 338.7 393.4 105.4c12.5-12.5
        32.8-12.5 45.3 0z"></path>
      </svg>
    </div>
  </div>
